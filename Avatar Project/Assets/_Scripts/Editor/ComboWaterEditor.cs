...
[CustomEditor(typeof(ComboWater))]
public class ComboWaterEditor : Editor
{
    ...
    {
        ComboWater script = (ComboWater)target;
    ...
    public void show(ComboWater script)
    {
    ...
    private void displayAction(ComboWater script)
    {
    ...
    private void displayRequiredInput(ComboWater script)
    {
    ...
    private void displayPreviousInput(ComboWater script)
    {
        GUILayout.BeginVertical();
