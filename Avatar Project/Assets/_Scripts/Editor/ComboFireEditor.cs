...
[CustomEditor(typeof(ComboFire))]
public class ComboFireEditor : Editor
{
    ...
    {
        ComboFire script = (ComboFire)target;
    ...
    public void show(ComboFire script)
    {
    ...
    private void displayAction(ComboFire script)
    {
    ...
    private void displayRequiredInput(ComboFire script)
    {
    ...
    private void displayPreviousInput(ComboFire script)
    {
        GUILayout.BeginVertical();
